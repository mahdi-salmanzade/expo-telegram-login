// Vendored from https://github.com/TelegramMessenger/telegram-login-ios @ tag 1.0.0
// Copyright (c) 2026 Telegram Messenger — MIT License
// See ios/Vendor/LICENSE-TelegramLogin for the full license text.
//
// Vendored because Telegram distributes this SDK as a Swift Package only, and
// Expo's CocoaPods integration cannot link a SwiftPM dependency from inside a
// Pod target. Once Telegram publishes a CocoaPods spec or a binary XCFramework,
// switch to a proper dependency.
