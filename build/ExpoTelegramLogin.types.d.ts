...
export type TelegramLoginErrorCode = 'NOT_CONFIGURED' | 'CANCELLED' | 'NO_AUTHORIZATION_CODE' | 'SERVER_ERROR' | 'REQUEST_FAILED' | 'UNKNOWN';
export declare class TelegramLoginError extends Error {
    code: TelegramLoginErrorCode;
    nativeMessage?: string;
    constructor(code: TelegramLoginErrorCode, message: string, nativeMessage?: string);
}
//# sourceMappingURL=ExpoTelegramLogin.types.d.ts.map